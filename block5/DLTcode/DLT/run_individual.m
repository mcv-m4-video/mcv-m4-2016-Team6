...
addpath('C:\Users\MiguelH\Documents\Tmp\block5\DLTcode\DLT\')

addpath('C:\Users\MiguelH\Documents\Tmp\block5\DLTcode\DLT\affineUtility\')
addpath('C:\Users\MiguelH\Documents\Tmp\block5\DLTcode\DLT\drawUtility\')
addpath('C:\Users\MiguelH\Documents\Tmp\block5\DLTcode\DLT\imageUtility\')
addpath('C:\Users\MiguelH\Documents\Tmp\block5\DLTcode\DLT\NN\')

dataPath = 'C:\Users\MiguelH\Documents\Tmp\block5\';
dataPath = 'C:\Users\MiguelH\Documents\Tmp\';
...
seq.init_rect = p; %[p(1) - p(3) / 2, p(2) - p(4) / 2, p(3), p(4), p(5)];

% Load data
disp('Loading data...');
fullPath = [dataPath, title, '\input\', '\'];
d = dir([fullPath, '*.jpg']);
if size(d, 1) == 0
    d = dir([fullPath, '*.png']);
end
