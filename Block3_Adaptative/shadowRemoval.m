...
for alpha=1:10
    for type=1:length(imagesIDs)
        ...
        dir = strcat(imagesID,imdir,imagesID,'-alpha-',num2str(alpha),'.mat');
        ...
        dir = strcat(imagesID,'/shadows-alpha-',num2str(alpha),'.mat');
        save(dir, 'shadows');
        dir = strcat(imagesID,'/new_masks-alpha-',num2str(alpha),'.mat');
